...
export function MessageIcon(props: { className?: string }) {
  return (
    <svg
      className={props.className}
      xmlns="http://www.w3.org/2000/svg"
...
export function UserCheckIcon(props: { className?: string }) {
  return (
    <svg
      className={props.className}
      xmlns="http://www.w3.org/2000/svg"
...
export function UserPlusIcon(props: { className?: string }) {
  return (
    <svg
      className={props.className}
      xmlns="http://www.w3.org/2000/svg"
...
export function NavigationIcon(props: { className?: string }) {
  return (
    <svg
      className={props.className}
      xmlns="http://www.w3.org/2000/svg"
...
export function WalkIcon(props: { className?: string }) {
  return (
    <svg
      className={props.className}
      width="800px"
...
export function BicycleIcon(props: { className?: string }) {
  return (
    <svg
      className={props.className}
      fill="#000000"
...
export function BusIcon(props: { className?: string }) {
  return (
    <svg
      className={props.className}
      width="800px"
    ...
    >
      <defs></defs>
      <circle className="cls-1" cx="6.27" cy="17.73" r="1.91" />
      <circle className="cls-1" cx="17.73" cy="17.73" r="1.91" />
      <path
        className="cls-1"
        d="M4.36,17.73H1.5V6.27A1.91,1.91,0,0,1,3.41,4.36H20.59A1.91,1.91,0,0,1,22.5,6.27V17.73H19.64"
      />
      <line className="cls-1" x1="15.82" y1="17.73" x2="8.18" y2="17.73" />
      <line className="cls-1" x1="17.73" y1="5.32" x2="17.73" y2="10.09" />
      <path
        className="cls-1"
        d="M22.5,13H19.64a1.9,1.9,0,0,1-1.91-1.9v-1H1.5"
      />
      <line className="cls-1" x1="13.91" y1="5.32" x2="13.91" y2="10.09" />
      <line className="cls-1" x1="6.27" y1="5.32" x2="6.27" y2="10.09" />
      <line className="cls-1" x1="10.09" y1="5.32" x2="10.09" y2="10.09" />
    </svg>
  );
}
